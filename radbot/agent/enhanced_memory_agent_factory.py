...
class EnhancedMemoryAgent(RadBotAgent):
    ...
    def __init__(self, memory_manager: Optional[EnhancedMemoryManager] = None, **kwargs):
        """
...
def create_enhanced_memory_agent(
    ...
    if not memory_service:
        ...
        logger.info(f"Connecting to Qdrant with: host={host}, port={port}, collection={collection}")
        if url:
