    ...
    def handle_calendar_request(
        ...
        try:
            if action == "list_events":
                ...
                return self.update_existing_event(event_id, is_workspace=is_workspace, **params)
            elif action == "delete_event":
                if "event_id" not in params:
                    return {"error": "Missing event_id parameter"}
                return self.delete_existing_event(params["event_id"], is_workspace=is_workspace)
