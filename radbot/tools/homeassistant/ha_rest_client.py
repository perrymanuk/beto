...
class HomeAssistantRESTClient:
    ...
    def call_service(self, domain: str, service: str, entity_id: Union[str, List[str]], 
                    additional_data: Optional[Dict[str, Any]] = None) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    def turn_on_entity(self, entity_id: str, **kwargs) -> Optional[List[Dict[str, Any]]]:
        """
        Turns on an entity.
