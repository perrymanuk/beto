...
def get_available_mcp_tools() -> List[Any]:
    ...
    if not tools:
        ...
        # Crawl4AI tools are now configured through MCP servers only
        # and will be loaded through the standard MCP server mechanism
...
def _create_tools_from_client(client: Any, server_config: Dict[str, Any]) -> List[Any]:
    ...
    try:
        ...
        # Special cases for server_id handling have been removed
        # All MCP servers should use the standard API
