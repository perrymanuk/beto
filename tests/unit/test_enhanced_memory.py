...
class TestMemoryDetector(unittest.TestCase):
    ...
    def test_memory_trigger_detection(self):
        ...
        for message in memory_messages:
            ...
            self.assertEqual(analysis['memory_type'], 'memories', f"Failed to detect memory trigger in: {message}")
        ...
        for message in fact_messages:
            analysis = self.detector.analyze_message(message)
            self.assertEqual(analysis['memory_type'], 'important_fact', f"Failed to detect fact trigger in: {message}")
    ...
    def test_no_trigger_detection(self):
        ...
        for message in regular_messages:
            analysis = self.detector.analyze_message(message)
            self.assertIsNone(analysis['memory_type'], f"Incorrectly detected trigger in: {message}")
    ...
    def test_custom_tag_extraction(self):
        ...
        self.assertEqual(set(analysis['custom_tags']), {'beto_infrastructure', 'beto_security'})
...
class TestMemoryManager(unittest.TestCase):
    ...
    def test_process_message_with_trigger(self, mock_store):
        ...
        mock_store.return_value = {'status': 'success', 'message': 'Successfully stored.'}
    ...
    def test_conversation_history_management(self):
        ...
        self.assertEqual(self.memory_manager.conversation_history[1]['role'], 'assistant')
