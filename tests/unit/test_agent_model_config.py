...
class TestAgentModelConfig(unittest.TestCase):
    ...
    def test_get_agent_model(self):
        ...
        self.assertEqual(self.mock_config.get_agent_model("code_execution_agent"), "gemini-2.5-pro-latest")
        self.assertEqual(self.mock_config.get_agent_model("search_agent"), "gemini-2.5-pro")
        self.assertEqual(self.mock_config.get_agent_model("scout_agent"), "gemini-2.5-pro-latest")
        self.assertEqual(self.mock_config.get_agent_model("todo_agent"), "gemini-2.0-flash")
        
        # Verify fallback for unknown agent
        self.mock_config.get_agent_model.side_effect = None
        self.mock_config.get_agent_model.return_value = self.mock_config.get_sub_agent_model()
        self.assertEqual(self.mock_config.get_agent_model("unknown_agent"), "gemini-2.0-flash")
    ...
    def test_environment_variable_override(self):
        ...
        self.assertEqual(agent_models.get("code_execution_agent"), "env-gemini-2.5-pro-latest")
