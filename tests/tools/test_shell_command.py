...
class TestShellCommand(unittest.TestCase):
    ...
    @patch("radbot.tools.shell_command.subprocess.run")
    ...
    def test_unsafe_arguments_rejected(self):
        ...
        # Test with other dangerous characters
    ...
    def test_get_shell_tool(self):
        ...
        self.assertEqual(len(strict_tool.function_declarations), 1)
        self.assertEqual(strict_tool.function_declarations[0].name, "execute_shell_command")
        self.assertIn("allow-listed", strict_tool.function_declarations[0].description)
        
        # Test in allow all mode
        allow_all_tool = get_shell_tool(strict_mode=False)
        self.assertIn("WARNING", allow_all_tool.function_declarations[0].description)
        self.assertIn("SECURITY RISK", allow_all_tool.function_declarations[0].description)

    @patch("radbot.tools.shell_tool.execute_shell_command")
