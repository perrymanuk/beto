...
class FileServerMCP:
    ...
    def __init__(self, root_dir: str, allow_write: bool = False, allow_delete: bool = False):
        """
        ...
        logger.info(f"Write operations: {'Enabled' if self.allow_write else 'Disabled'}")
        logger.info(f"Delete operations: {'Enabled' if self.allow_delete else 'Disabled'}")
...
def setup_mcp_server(root_dir: str, allow_write: bool = False, allow_delete: bool = False) -> Tuple[Server, FileServerMCP]:
    """
    ...
    async def list_tools() -> List[mcp_types.Tool]:
        ...
        tools = [
            mcp_types.Tool(
                ...
                parameters=mcp_types.Parameters(properties={
                    "path": mcp_types.Parameter(
                        type="string",
            ...
            tools.extend([
                mcp_types.Tool(
                    ...
                    parameters=mcp_types.Parameters(properties={
                        ...
                        "content": mcp_types.Parameter(
                            type="string",
                            description="Content to write"
                        ),
                        "append": mcp_types.Parameter(
                            type="boolean",
                ...
                mcp_types.Tool(
                    ...
                    parameters=mcp_types.Parameters(properties={
                        "source": mcp_types.Parameter(
                            type="string",
                            description="Source path (relative to root directory)"
                        ),
                        "destination": mcp_types.Parameter(
                            type="string",
...
def main():
    ...
    parser.add_argument(
        "root_dir", 
        help="Root directory for filesystem operations"
    )
    parser.add_argument(
        "--allow-write", 
        action="store_true", 
